<?php  require('action/loginActionDoc.php');  ?>
            ...
            echo'<p>'.$errorMsg.'</p>';
                ...
                <span>
                   <img src="image/lock.svg" alt="">
                    ...
                    <div class="inscription"><p>Si vous n'étes pas encore inscrit veuillez cliqué sur, <a href="inscriptiondoc.php">s'inscrire</a> </p></div>
            </form>
        </div>
    </div>
</body>
